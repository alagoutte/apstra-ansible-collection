...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-body/force_accept"></div>

      .. raw:: latex

        \hspace{0.02\textwidth}\begin{minipage}[t]{0.3\textwidth}

      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-body/force_accept:
      ...
      **force_accept**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-body/force_accept" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      Used with :literal:`state=host\_key\_updated`.

      When :literal:`true`\ , the stored SSH authorized key is cleared so the next connection re\-validates the host key (accepts a changed key).

      When :literal:`false` and the agent is already connected, the operation is a no\-op (idempotent).
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/agent_ids:
    ...
    - .. raw:: html
      ...
      List of agent UUIDs. Used with :literal:`state=host\_key\_updated` to update host keys on multiple agents in one task.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/blueprint:
    ...
    - .. raw:: html
      ...
      Blueprint name or UUID. Required when :literal:`id.system\_name` or :literal:`id.system\_names` is used.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-id/management_ip"></div>

      .. raw:: latex

        \hspace{0.02\textwidth}\begin{minipage}[t]{0.3\textwidth}

      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/management_ip:
      ...
      **management_ip**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-id/management_ip" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      Management IP address of the device. Used by :literal:`state=host\_key\_updated` to locate the agent when :literal:`id.agent\_id` is not known.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-indent"></div><div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-id/management_ips"></div>

      .. raw:: latex

        \hspace{0.02\textwidth}\begin{minipage}[t]{0.3\textwidth}

      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/management_ips:
      ...
      **management_ips**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-id/management_ips" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      List of management IP addresses. Used with :literal:`state=host\_key\_updated` to update host keys on multiple agents by IP.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/system_name:
    ...
    - .. raw:: html
      ...
      Blueprint node label (human\-readable device name such as :literal:`DC2\-Leaf1`\ ). Used with :literal:`state=host\_key\_updated` to look up the agent via the blueprint. Requires :literal:`id.blueprint`.
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.juniper.apstra.system_agents_module__parameter-id/system_names:
    ...
    - .. raw:: html
      ...
      List of blueprint node labels. Used with :literal:`state=host\_key\_updated` to update host keys on multiple devices by name. Requires :literal:`id.blueprint`.
  ...
  * - .. raw:: html
    ...
    - .. raw:: html
      ...
      :literal:`host\_key\_updated` triggers :literal:`POST /system\-agents/{id}/update\-host\-keys` which re\-learns the current SSH host key of the device, clearing any cached mismatch. Useful after a device OS upgrade or re\-image changes the SSH fingerprint. Set :literal:`body.force\_accept=true` (default) to always run; with :literal:`body.force\_accept=false` the operation is a no\-op when the agent is already in :literal:`connected` state (safe idempotency check). Accepts single or list id forms \- :literal:`id.agent\_id`\ , :literal:`id.management\_ip`\ , :literal:`id.system\_name`\ +\ :literal:`id.blueprint`\ , or the corresponding list variants :literal:`id.agent\_ids`\ , :literal:`id.management\_ips`\ , :literal:`id.system\_names`.
      ...
      - :ansible-option-choices-entry:`"host\_key\_updated"`
...
.. list-table::
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="return-host_key_cleared"></div>

      .. _ansible_collections.juniper.apstra.system_agents_module__return-host_key_cleared:
      ...
      **host_key_cleared**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#return-host_key_cleared" title="Permalink to this return value"></a>
    ...
    - .. raw:: html
      ...
      Only returned when :literal:`state=host\_key\_updated`.


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when state=host\_key\_updated
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.juniper.apstra.system_agents_module__return-results:
    ...
    - .. raw:: html
      ...
      Per\-device result list when multiple devices were specified (e.g. :literal:`id.agent\_ids`\ , :literal:`id.management\_ips`\ , :literal:`id.system\_names`\ ).

      Each entry contains :literal:`agent\_id`\ , :literal:`changed`\ , :literal:`msg`\ , :literal:`connection\_state`.

      Only returned when :literal:`state=host\_key\_updated` with list input.


      .. rst-class:: ansible-option-line

      :ansible-option-returned-bold:`Returned:` when state=host\_key\_updated and multiple devices given
